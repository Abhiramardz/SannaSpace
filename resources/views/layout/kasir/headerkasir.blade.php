...
<header class="bg-white/80 backdrop-blur-md sticky top-0 z-40 px-6 py-4 border-b border-gray-100 flex justify-between items-center">
    <div class="flex items-center gap-4">
        ...
        <button id="mobile-menu-btn" class="md:hidden p-2 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all">
        ...
        <div>
            ...
            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest hidden md:block">Kasir Panel • Sanna Space</p>
        </div>
    </div>
    
    <div class="flex items-center gap-3">
        <div class="hidden md:flex flex-col items-end mr-2">
            <span class="text-sm font-bold text-gray-800">{{ Auth::user()->name ?? 'Kasir' }}</span>
            <span class="text-[10px] text-blue-500 font-bold uppercase tracking-widest">Aktif</span>
        </div>
